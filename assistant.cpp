...
public:
    TCPServer(ConversationManager& manager, int port = 8080) : convManager(manager) {
#ifdef _WIN32
        WSADATA wsaData;
...
public:
    ...
    void start() {
        ...
        convManager.addMessage("assistant", "C++ Voice Assistant started. Ready for communication.");
